...
func main() {
	...
	app.Action = func(c cmd.Config) {
		...
		raRPC, err := rpc.NewAmqpRPCClient("VA->RA", c.AMQP.RA.Server, c, clock.Default(), stats)
		...
		vas, err := rpc.NewAmqpRPCServer(c.AMQP.VA.Server, c.VA.MaxConcurrentRPCServerRequests)
