// Portions of this code were sourced from the go vet tool. That code
// has the copyright below.
//
// Copyright 2010 The Go Authors. All rights reserved.
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.

// Bouldervet is a simple checker for errors in boulder Go source
// code. It is not a replacement for go vet. In fact, it's best to run
// go vet before running this code.
package main
