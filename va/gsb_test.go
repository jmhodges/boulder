...
func TestIsSafeDomain(t *testing.T) {
	// TODO(jmhodges): use more of the GSB lib by teaching it how to not make http requests
...
func TestAllowNilInIsSafeDomain(t *testing.T) {
	...
	// This is mocked out at the wrong level because the gsb lib we rely on is a
	// little funny and overcomplicated, but still hasn't learned out how not
