...
//go:generate sh -c "mockgen -package mockstatsd github.com/cactus/go-statsd-client/statsd Statter > ./metrics/mockstatsd/mockstatsd.go && sed -i '' -e 's:github.com/golang/mock/gomock:github.com/letsencrypt/boulder/Godeps/_workspace/src/github.com/golang/mock/gomock:' ./mockstatsd/mockstatsd.go"
